...
public partial class User
{
    ...
    public virtual ICollection<NotiSpecuser> NotiSpecuserFromUsers { get; } = new List<NotiSpecuser>();

    public virtual ICollection<NotiSpecuser> NotiSpecuserToUsers { get; } = new List<NotiSpecuser>();
