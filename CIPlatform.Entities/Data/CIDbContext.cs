...
namespace CIPlatformWeb.Entities.Data;
...
public partial class CIDbContext : DbContext
{
    ...
    public virtual DbSet<NotiSpecuser> NotiSpecusers { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA41418E5A78EA");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C34FF8379C9");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8690D6014");
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.Cities)
                ...
                .HasConstraintName("FK__city__country_id__4A8310C6");
        });

        modelBuilder.Entity<CmsPage>(entity =>
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52A3B02AD5");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687DC6996CD");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Comments)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__comment__mission__625A9A57");

            entity.HasOne(d => d.User).WithMany(p => p.Comments)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__comment__user_id__6166761E");
        });

        modelBuilder.Entity<ContactU>(entity =>
        {
            entity.HasKey(e => e.ContactUsId).HasName("PK__contact___2DE2876E8234B2E0");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.ContactUs)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__contact_u__user___00750D23");
        });

        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD0551566AC59");
        ...
        {
            entity.HasKey(e => e.FavoriteMissionId).HasName("PK__favorite__B4CF3312376E2327");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.FavoriteMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__favorite___missi__2EDAF651");

            entity.HasOne(d => d.User).WithMany(p => p.FavoriteMissions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__favorite___user___2DE6D218");
        });

        modelBuilder.Entity<GoalMission>(entity =>
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7B29D731E");

            entity.ToTable("goal_mission");

            entity.Property(e => e.GoalMissionId).HasColumnName("goal_mission_id");
            entity.Property(e => e.AchievedValue).HasColumnName("achieved_goal");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.GoalMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__goal_miss__missi__02FC7413");
        });

        modelBuilder.Entity<Mission>(entity =>
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB276899AF9");
            ...
            entity.Property(e => e.CreatedAt)
                ...
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            entity.Property(e => e.MissionDeadline)
                .HasColumnType("datetime")
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Missions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission__city_id__5CD6CB2B");
            ...
            entity.HasOne(d => d.MissionTheme).WithMany(p => p.Missions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission__mission__5BE2A6F2");
        });

        modelBuilder.Entity<MissionApplication>(entity =>
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838ACA45A671");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_a__missi__3493CFA7");

            entity.HasOne(d => d.User).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_a__user___3587F3E0");
        });

        modelBuilder.Entity<MissionDocument>(entity =>
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC8C5B5F1C7");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED1585BEBE9B0");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E82AF725B5");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionMedia)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_m__missi__71D1E811");
        });

        modelBuilder.Entity<MissionRating>(entity =>
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E51726A0321A9");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__missi__45BE5BA9");

            entity.HasOne(d => d.User).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_r__user___44CA3770");
        });

        modelBuilder.Entity<MissionSkill>(entity =>
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___827120087FB7D6B6");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_s__missi__6AEFE058");

            entity.HasOne(d => d.Skill).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_s__skill__69FBBC1F");
        });

        modelBuilder.Entity<MissionTheme>(entity =>
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5ACBFF6227C");
        ...
        modelBuilder.Entity<NotiSpecuser>(entity =>
        {
            entity.HasKey(e => e.NotspecId).HasName("PK__noti_spe__F2C3D5CA78F7E9CA");

            entity.ToTable("noti_specuser");

            entity.Property(e => e.NotspecId).HasColumnName("notspec_id");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.NotiSpecuserFromUsers)
                .HasForeignKey(d => d.FromUserid)
                .HasConstraintName("FK__noti_spec__from___0A688BB1");

            entity.HasOne(d => d.ToUser).WithMany(p => p.NotiSpecuserToUsers)
                .HasForeignKey(d => d.ToUserid)
                .HasConstraintName("FK__noti_spec__to_us__0B5CAFEA");
        });

        modelBuilder.Entity<NotiType>(entity =>
        {
            entity.HasKey(e => e.NottypeId).HasName("PK__noti_typ__05EEFEA469D459CB");

            entity.ToTable("noti_type");

            entity.Property(e => e.NottypeId).HasColumnName("nottype_id");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
                .HasColumnName("created_at");
        ...
        {
            entity.HasKey(e => e.NotallId).HasName("PK__notif_al__D56BCC96E550786A");
        ...
        {
            entity.HasKey(e => e.NotprefId).HasName("PK__notif_pr__A16243F0F69AE021");

            entity.ToTable("notif_preference");

            entity.Property(e => e.NotprefId).HasColumnName("notpref_id");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            ...
            entity.HasOne(d => d.Nottype).WithMany(p => p.NotifPreferences)
                .HasForeignKey(d => d.NottypeId)
                .HasConstraintName("FK__notif_pre__notty__2057CCD0");

            entity.HasOne(d => d.User).WithMany(p => p.NotifPreferences)
                .HasForeignKey(d => d.Userid)
                .HasConstraintName("FK__notif_pre__useri__1F63A897");
        });
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA837940EEAD71");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C5601EDE5EF");
            ...
            entity.Property(e => e.UpdatedAt)
                ...
                .HasColumnName("updated_at");
            entity.Property(e => e.UserId).HasColumnName("user_id");
            entity.Property(e => e.ViewCount).HasColumnName("views");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Stories)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story__user_id__1AD3FDA4");
        });

        modelBuilder.Entity<StoryInvite>(entity =>
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867ACE05581");
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.StoryInviteFromUsers)
                .HasForeignKey(d => d.FromUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_inv__from___2739D489");

            entity.HasOne(d => d.Story).WithMany(p => p.StoryInvites)
                .HasForeignKey(d => d.StoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_inv__story__607251E5");

            entity.HasOne(d => d.ToUser).WithMany(p => p.StoryInviteToUsers)
                .HasForeignKey(d => d.ToUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_inv__to_us__282DF8C2");
        });

        modelBuilder.Entity<StoryMedium>(entity =>
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C314A307B");
            ...
            entity.HasOne(d => d.Story).WithMany(p => p.StoryMedia)
                .HasForeignKey(d => d.StoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_med__story__634EBE90");
        });

        modelBuilder.Entity<Timesheet>(entity =>
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068397177C7");
            ...
            entity.Property(e => e.Status)
                ...
                .HasDefaultValueSql("('PENDING')")
                .HasColumnName("status");
            entity.Property(e => e.TotalTime).HasColumnName("time");
            entity.Property(e => e.UpdatedAt)
                .HasColumnType("datetime")
                .HasColumnName("updated_at");
            entity.Property(e => e.UserId).HasColumnName("user_id");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Timesheets)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__timesheet__missi__531856C7");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F9E161348");
            ...
            entity.Property(e => e.Avatar)
                .HasMaxLength(2048)
                .IsUnicode(false)
                .HasDefaultValueSql("('\\images\\default-user-icon.png')")
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BB4615F26");
            ...
            entity.HasOne(d => d.Skill).WithMany(p => p.UserSkills)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_skil__skill__5BAD9CC8");

            entity.HasOne(d => d.User).WithMany(p => p.UserSkills)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_skil__user___5AB9788F");
        });
