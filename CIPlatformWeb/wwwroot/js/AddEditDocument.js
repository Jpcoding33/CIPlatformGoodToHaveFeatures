...
!(function (e) {
    e.fn.docsUploader = function (t) {
        ...
        let o = function () {
            ...
            l = function (t, i, o) {
                let l = e("<div>", { class: "uploaded-doc" }),
                    txt = t.slice(18,);
                    r =
                        (e("<a>", { href: t, alt: t, target: "_blank" }).appendTo(l),
                        e("<p>", { text: txt, class : "docName" }).appendTo(l),
                        e("<div>", { class : "overlayImg" }).appendTo(l),
                            e("<button>", { class: "delete-doc" }).appendTo(l));
